...
figure
plot (t , y(1,:)) ; title('distancia delta con phi_i=-0.01 y m=0.1 sistemaNL'); xlabel('tiempo[s]'); ylabel('delta[m]');
figure
plot (t, y(3,:)); title('angulo phi_i=-0.01 y m=0.1 sistemaNL'); xlabel('tiempo[s]'); ylabel('phi[rad]');
...
figure
plot (t , y(1,:)) ; title('distancia delta con phi_i=3.01 y m=0.1 sistemaNL'); xlabel('tiempo[s]'); ylabel('delta[m]');
figure
plot (t, y(3,:)); title('angulo phi_i=3.01 y m=0.1 sistemaNL'); xlabel('tiempo[s]'); ylabel('phi[rad]');
...
%{
--------------------------------------------------------------------------
2- Modificar la masa m al doble y repetir la operación anterior
--------------------------------------------------------------------------
%}
%parametros para la primera consigna puntos de op X1=[0,0,-0.01,0] y X2=[0,0,3.01,0]
...
figure
plot (t , y(1,:)) ; title('distancia delta con phi_i=-0.01 y m=0.2 sistemaNL'); xlabel('tiempo[s]'); ylabel('delta[m]');
figure
plot (t, y(3,:)); title('angulo phi_i=-0.01 y m=0.2 sistemaNL'); xlabel('tiempo[s]'); ylabel('phi[rad]');
...
figure
plot (t , y(1,:)) ; title('distancia delta con phi_i=3.01 y m=0.2 sistemaNL'); xlabel('tiempo[s]'); ylabel('delta[m]');
figure
plot (t, y(3,:)); title('angulo phi_i=3.01 y m=0.2 sistemaNL'); xlabel('tiempo[s]'); ylabel('phi[rad]');
...
%{
--------------------------------------------------------------------------
3- Obtener la representación lineal en variables de estado para el
...
%{
--------------------------------------------------------------------------
4- Obtener la solución numérica de los dos sistemas, del lineal y del no lineal para evaluar 
...
%defino condifiones iniciales  a partir del punto de operacion
delta = 0; delta_p = 0; phi = 0.015; phi_p = 0;
...
figure
plot (t , yNL(1,:),'G') ; %title('distancia delta con phi=-0.01, l=1.2 y m=0.01 sistemaNL');xlabel('tiempo[s]');ylabel('delta[m]'); 
hold on
plot (t , y(1,:),'R') ; title('distancia delta con phi=0,015, l=1.2 y m=0.01 sistemaL VS sistemaNL'); xlabel('tiempo[s]'); ylabel('delta[m]');
legend( 'Sistema No Linealizado','Sistema Linealizado' );

figure
plot (t, yNL(3,:),'G');% title('angulo phi=0,015, l=1.2 y m=0.01 sistemaNL'); xlabel('tiempo[s]'); ylabel('phi[rad]');
hold on 
plot (t, y(3,:),'R'); title('angulo phi=0,015, l=1.2 y m=0.01 sistemaL VS sistemaNL'); xlabel('tiempo[s]'); ylabel('phi[rad]');
legend( 'Sistema No Linealizado','Sistema Linealizado' );
%%
%{
--------------------------------------------------------------------------
...
%defino condifiones iniciales  a partir del punto de operacion
delta = 0; delta_p = 0; phi = pi-0.3; phi_p = 0;
